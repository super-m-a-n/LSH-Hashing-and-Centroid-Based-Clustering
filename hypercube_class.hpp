...
public:
	...
	std::vector <std::pair <double, const Object*> > appr_nearest_neighbors(const Dataset & dataset, const Object & query_object, std::ofstream & file, const int & N, double (*metric)(const Object &, const Object &));
